...
vim.api.nvim_set_keymap("n", "s)", "ciw(<C-r>\")<Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "s]", "ciw[<C-r>\"]<Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "s}", "ciw{<C-r>\"}<Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "s>", "ciw<lt><C-r>\"><Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "s\"", "ciw\"<C-r>\"\"<Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "s'", "ciw'<C-r>\"'<Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "s'", "ciw'<C-r>\"'<Esc>", { noremap = true })
...
vim.api.nvim_set_keymap("n", "sw]", "ciW[<C-r>\"]<Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "sw}", "ciW{<C-r>\"}<Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "sw>", "ciW<lt><C-r>\"><Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "sw\"", "ciW\"<C-r>\"\"<Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "sw'", "ciW'<C-r>\"'<Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "sw'", "ciW'<C-r>\"'<Esc>", { noremap = true })

-- emulate surround delete bindings

vim.api.nvim_set_keymap("n", "ds)", "vi(dvhp", { noremap = true })
vim.api.nvim_set_keymap("n", "ds]", "vi[dvhp", { noremap = true })
vim.api.nvim_set_keymap("n", "ds}", "vi{dvhp", { noremap = true })
vim.api.nvim_set_keymap("n", "ds>", "vi<dvhp", { noremap = true })
vim.api.nvim_set_keymap("n", "ds\"", "vi\"dvhp", { noremap = true })
...
-- emulate surround change bindings

vim.api.nvim_set_keymap("n", "cs\"'", "vi\"l<Esc>msvi\"oh<Esc>cl'<Esc>`scl'<Esc>", { noremap = true })
vim.api.nvim_set_keymap("n", "cs'\"", "vi'l<Esc>msvi'oh<Esc>cl\"<Esc>`scl\"<Esc>", { noremap = true })

-- emulate surround selected text

vim.api.nvim_set_keymap("v", "S\"", "c\"<C-r>\"\"<Esc>", { noremap = true })
vim.api.nvim_set_keymap("v", "S'", "c'<C-r>\"'<Esc>", { noremap = true })
vim.api.nvim_set_keymap("v", "S)", "c(<C-r>\")<Esc>", { noremap = true })
vim.api.nvim_set_keymap("v", "S]", "c[<C-r>\"]<Esc>", { noremap = true })
vim.api.nvim_set_keymap("v", "S}", "c{<C-r>\"}<Esc>", { noremap = true })
vim.api.nvim_set_keymap("v", "S>", "c<lt><C-r>\"><Esc>", { noremap = true })
vim.api.nvim_set_keymap("v", "S*", "c*<C-r>\"*<Esc>", { noremap = true })
